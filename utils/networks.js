...
if (result.error) {
  console.error('Couldnt load ".env" file makes sure its created and contains the necessary values (see https://github.com/Esteroids/WNFT-contract#setting-environment-variables for more details)')
  process.exit(1)
}
